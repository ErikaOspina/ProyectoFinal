<?php 
    ...
    $mat_id = $mat_nombre = $mat_estado = $mat_estado = $mat_horas = $mat_horas "";
                    ...
                    <div class="card-body">
                        <form action="update.php" method="POST" name="forrol">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="estado" name="estado" value="<?= $mat_estado ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="horas">Horas</label>
                                <input type="text" class="form-control" id="horas" name="horas" value="<?= $mat_horas ?>" required>
                            </div>
