            ...
            <div class="col-sm-8 col-xl-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= ROOT ?>modulos/materias/addmaterias.php" class="btn btn-primary">Crear Materias</a>
                    </div>
                    <div class="card-body">
                        <?php 
                            $mensajes = array(
                                ...
                                <?php 
                                    ...
                                    foreach($result as $row) {
                                        echo "<tr>
                                                ...
                                                <td>".$row['horas']."</td>
                                                <td>
                                                    <a href='editMateria.php?id=".$row['id']."' class='btn btn-primary btn-sm'><i class='fa fa-edit'></i></a>
